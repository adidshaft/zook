...
export const publicMessages = {
  en: {
    ...
    reviews: "Reviews",
    reviewsPending:
      "Member reviews will appear here after this gym starts collecting feedback through Zook.",
    ...
    simulatedPayment: "Continue to simulated payment",
    ...
    signInDefault: "Enter your email or phone number to receive a one-time password.",
  ...
  hi: {
    ...
    reviews: "रिव्यू",
    reviewsPending: "जिम Zook से प्रतिक्रिया लेना शुरू करेगा तो सदस्य रिव्यू यहां दिखेंगे.",
    ...
    simulatedPayment: "सिम्युलेटेड भुगतान जारी रखें",
    ...
    signInDefault: "वन-टाइम पासवर्ड पाने के लिए अपना ईमेल या फोन नंबर दर्ज करें.",
