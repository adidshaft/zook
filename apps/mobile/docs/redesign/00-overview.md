...
2. **Two parallel design systems** — `src/components/primitives/foundation.tsx` (3,712 lines) sits alongside the split primitives (`buttons.tsx`, input/metric/layout primitives, and feedback primitives). Some screens import old, some import split. The `theme.ts` file has 6 `@deprecated` aliases still in active use.
...
└── src/
    ...
    │   │   ├── buttons.tsx, input-primitives.tsx, metric-primitives.tsx,
    │   │   ├── layout-primitives.tsx, feedback-primitives.tsx, bottom-nav-context.tsx,
