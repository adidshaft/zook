...
export const typography = {
  screenTitle: { fontSize: 30, fontFamily: "Inter_600SemiBold", lineHeight: 36 },
  headerTitle: { fontSize: 24, fontFamily: "Inter_600SemiBold", lineHeight: 30 },
  sectionTitle: { fontSize: 21, fontFamily: "Inter_600SemiBold", lineHeight: 27 },
  cardTitle: { fontSize: 18, fontFamily: "Inter_600SemiBold", lineHeight: 24 },
  ...
  caption: { fontSize: 12, fontFamily: "Inter_600SemiBold", lineHeight: 16 },
  small: { fontSize: 13, fontFamily: "Inter_400Regular", lineHeight: 18 },
  metric: { fontSize: 32, fontFamily: "Inter_600SemiBold", lineHeight: 38 },
  navLabel: { fontSize: 11, fontFamily: "Inter_600SemiBold", lineHeight: 14 },
  button: { fontSize: 15, fontFamily: "Inter_600SemiBold", lineHeight: 20 },

  // Compatibility aliases used by existing screens.
  display: { fontSize: 42, fontFamily: "Inter_700Bold", lineHeight: 48 },
  h1: { fontSize: 30, fontFamily: "Inter_600SemiBold", lineHeight: 36 },
  h2: { fontSize: 24, fontFamily: "Inter_600SemiBold", lineHeight: 30 },
  h3: { fontSize: 18, fontFamily: "Inter_600SemiBold", lineHeight: 24 },
  headline: { fontSize: 30, fontFamily: "Inter_600SemiBold", lineHeight: 36 },
