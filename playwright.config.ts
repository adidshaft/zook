  ...
  webServer: {
    ...
    env: {
      ...
      ...pickDefinedEnv(playwrightForwardEnvKeys, {
        ...
        SERVER_CACHE_PROVIDER: process.env.PLAYWRIGHT_SERVER_CACHE_PROVIDER ?? "disabled",
        STORAGE_PROVIDER: process.env.PLAYWRIGHT_STORAGE_PROVIDER ?? "local",
        STORAGE_LOCAL_DIR: process.env.PLAYWRIGHT_STORAGE_LOCAL_DIR ?? ".local/playwright-uploads",
      }),
    },
    url: webServerUrl,
